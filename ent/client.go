...
import (
	...
	"github.com/dpolimeni/fiber_app/ent/migrate"
...
func (c *EventsClient) UpdateOneID(id int32) *EventsUpdateOne {
...
func (c *EventsClient) DeleteOneID(id int32) *EventsDeleteOne {
...
func (c *EventsClient) Get(ctx context.Context, id int32) (*Events, error) {
	return c.Query().Where(events.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *EventsClient) GetX(ctx context.Context, id int32) *Events {
...
// QueryUsers queries the users edge of a Events.
func (c *EventsClient) QueryUsers(e *Events) *UserQuery {
...
func (c *UserClient) QueryEvents(u *User) *EventsQuery {
